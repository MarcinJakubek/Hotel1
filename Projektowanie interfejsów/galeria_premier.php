	...
	<div id="rodzic">
		...
		<div id="panel_glowny">
			...
			<br>
				...
				<div class="row">
				<div class="column">
					<img src="Premier_galeria/1.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Premier_galeria/2.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Premier_galeria/3.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Premier_galeria/4.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				</div>
