	...
	<div class="Panel_boczny_do_pozyckonowania">
		...
		<div class="SortowanieFormularz2">		
				...
				<?php
						$sort=$_POST['sort'];
						if ($sort=="All") {
							header('location: wolne_pokoje.php');
						} else {
						// Połączenie z bazą
						...
						$sql = "SELECT room.id, room.type, room.Galeria, room.bedding, room.arrival, room. departure, price_list.price FROM room, price_list WHERE room.type = price_list.service AND place='Free' AND bedding='$sort'";
