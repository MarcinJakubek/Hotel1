	...
	<div id="rodzic">
		...
		<div id="panel_glowny">
			...
			<div class="tytol_strony">
				Pokój executive <br> (Dla biznesmenów)
			</div>
			<br>
			<br>
				<!-- The four columns -->
				<div class="row">
				<div class="column">
					<img src="Executive_galeria/1.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Executive_galeria/2.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Executive_galeria/3.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				<div class="column">
					<img src="Executive_galeria/4.jpg" style="width:100%" onclick="myFunction(this);">
				</div>
				</div>
